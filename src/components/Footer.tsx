  ...
  return (
    <footer className="mt-20 border-t border-pink-100 bg-pink-50">
      <div className="container-shell grid gap-8 py-12 md:grid-cols-3">
        <div>
          <h3 className="font-semibold text-brand-900">{contactLinks.brand.name}</h3>
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-700">Phone: {contactLinks.contact.phone ?? siteConfig.phone}</p>
          <a className="text-sm text-brand-700" href={contactLinks.social.tiktok ?? siteConfig.tiktok} target="_blank" rel="noreferrer">
            TikTok
          </a>
        </div>
      </div>
